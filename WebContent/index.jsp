...
<head>
    ...
    <link href="resourcescss/custom.css" rel="stylesheet">
                    ...
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand home" href="index.html">
                                <img src="resources/img/logo.png" alt="Universal logo" class="hidden-xs hidden-sm">
                                <img src="resources/img/logo-small.png" alt="Universal logo" class="visible-xs visible-sm"><span class="sr-only">Universal - go to homepage</span>
                            </a>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <div class="yamm-content">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <img src="resources/img/template-easy-customize.png" class="img-responsive hidden-xs" alt="">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <h5>Shortcodes</h5>
                                                        <ul>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <div class="yamm-content">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <img src="resources/img/template-homepage.png" class="img-responsive hidden-xs" alt="">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <h5>Portfolio</h5>
                                                        <ul>
                    ...
                    <div class="homepage owl-carousel">
                        <div class="item">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <img class="img-responsive" src="resources/img/template-homepage.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="row">
                                ...
                                <div class="col-sm-7 text-center">
                                    <img class="img-responsive" src="resources/img/template-mac.png" alt="">
                                </div>
                        ...
                        <div class="item">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <img class="img-responsive" src="resources/img/template-easy-customize.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="row">
                                <div class="col-sm-7">
                                    <img class="img-responsive" src="resources/img/template-easy-code.png" alt="">
                                </div>
                                <div class="col-sm-5">
                            ...
                            <li class="item">
                                <div class="testimonial same-height-always">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <div class="name-picture">
                                            <img class="" alt="" src="resources/img/person-3.png">
                                            <h5>John McIntyre</h5>
                                            <p>CEO, TransTech</p>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                <div class="top">
                                    <div class="image">
                                        <img src="resources/img/portfolio-4.jpg" alt="" class="img-responsive">
                                    </div>
                                    <div class="bg"></div>
                                    <div class="text">
                                        <p class="buttons">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                <div class="top">
                                    <div class="image">
                                        <img src="resources/img/portfolio-3.jpg" alt="" class="img-responsive">
                                    </div>
                                    <div class="bg"></div>
                                    <div class="text">
                                        <p class="buttons">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                <div class="top">
                                    <div class="image">
                                        <img src="resources/img/portfolio-5.jpg" alt="" class="img-responsive">
                                    </div>
                                    <div class="bg"></div>
                                    <div class="text">
                                        <p class="buttons">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                <div class="top">
                                    <div class="image">
                                        <img src="resources/img/portfolio-6.jpg" alt="" class="img-responsive">
                                    </div>
                                    <div class="bg"></div>
                                    <div class="text">
                                        <p class="buttons">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="owl-carousel customers">
                            <li class="item">
                                <img src="resources/img/customer-1.png" alt="" class="img-responsive">
                            </li>
                            <li class="item">
                                <img src="resources/img/customer-2.png" alt="" class="img-responsive">
                            </li>
                            <li class="item">
                                <img src="resources/img/customer-3.png" alt="" class="img-responsive">
                            </li>
                            <li class="item">
                                <img src="resources/img/customer-4.png" alt="" class="img-responsive">
                            </li>
                            <li class="item">
                                <img src="resources/img/customer-5.png" alt="" class="img-responsive">
                            </li>
                            <li class="item">
                                <img src="resources/img/customer-6.png" alt="" class="img-responsive">
                            </li>
                        </ul>
                        <!-- /.owl-carousel -->
                    </div>
            ...
            <div class="container">
                    ...
                    <div class="blog-entries">
                        <div class="item same-height-row clearfix">
                            <div class="image same-height-always">
                                <a href="#">
                                    <img class="img-responsive" src="resources/img/detailsquare.jpg" alt="">
                                </a>
                            </div>
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="photostream">
                        <div>
                            <a href="#">
                                <img src="resources/img/detailsquare.jpg" class="img-responsive" alt=resources/img>
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <img src="resources/img/detailsquare2.jpg" class="img-responsive" alt="#">
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <img src="resources/img/detailsquare3.jpg" class="img-responsive" alt="#">
                            </a>
                        </div>
                        <div>
                            <a href="#">
                        ...
                        <div>
                            <a href="#">
                                <img src="resources/img/detailsquare.jpg" class="img-responsive" alt="#">
                            </a>
                        </div>
                    </div>
